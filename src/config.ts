...
export const siteConfig: SiteConfig = {
	title: "Reidho Satria",
	subtitle:
		"A passionate CTF Player & Network Security Engineer specializing in cryptography, binary exploitation, and reverse engineering.",
...
export const profileConfig: ProfileConfig = {
	...
	name: "Reidho Satria",
	bio: "A passionate CTF Player & Network Security Engineer specializing in cryptography, binary exploitation, and reverse engineering.",
	links: [
		{
			name: "Twitter",
