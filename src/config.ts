...
export const siteConfig: SiteConfig = {
	title: "Reidho Satria",
	subtitle:
		"A passionate Cybersecurity Analyst & Network Security Engineer specializing in cryptography and binary exploitation.",
...
export const profileConfig: ProfileConfig = {
	...
	name: "Reidho Satria",
	bio: "A passionate Cybersecurity Analyst & Network Security Engineer specializing in cryptography and binary exploitation.",
	links: [
		{
			name: "Twitter",
